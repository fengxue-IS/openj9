...
public final class MethodHandleHelper {
	...
	@SuppressWarnings("unused")
	private static final Object resolveMethodHandle(Class<?> callerClass, int refKind, Class<?> defc, String name, String type) throws Throwable {
		...
		result[0] = MethodHandleNatives.linkMethod(callerClass, refKind, defc, name, mt, appendixResult);
