...
#define J9ROMMETHOD_HAS_LAMBDAFROM_HIDDEN_ANNOTATION(extendedModifiers)	J9_ARE_ALL_BITS_SET(extendedModifiers, CFR_METHOD_EXT_LAMBDAFORM_HIDDEN_ANNOTATIONS)
