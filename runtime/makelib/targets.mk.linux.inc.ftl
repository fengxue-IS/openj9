...
<#elseif uma.spec.processor.ppc>
  ...
  <#else>
    CFLAGS += -qalias=noansi -qxflag=LTOL:LTOL0 -qxflag=selinux -qstackprotect
    CXXFLAGS += -qalias=noansi -qxflag=LTOL:LTOL0 -qxflag=selinux -qsuppress=1540-1087:1540-1088:1540-1090 -qstackprotect
    CPPFLAGS += -qstackprotect
    ifdef j9vm_env_data64
    <#if uma.spec.flags.env_littleEndian.enabled>
      CFLAGS += -qarch=pwr7
      CXXFLAGS += -qarch=pwr7
...
<#elseif uma.spec.processor.s390>
  ...
  CXXFLAGS += $(J9M31) -DS390 -D_LONG_LONG -DJ9VM_TIERED_CODE_CACHE -fno-strict-aliasing -fstack-protector
