...
retry:
	...
	if ((sizeof(J9Class) + sizeof(UDATA)) == vTableOffset) {
...
old_slow_icallVMprJavaSendPatchupVirtual(J9VMThread *currentThread)
{
	...
	J9Method *method = *(J9Method**)(interpVTableOffset + (UDATA)clazz);
	...
	UDATA *jitVTableSlot = (UDATA*)(jitVTableOffset + (UDATA)clazz);
