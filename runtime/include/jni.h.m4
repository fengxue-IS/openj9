...
ifelse(LOOM_SUPPORT, ON, `	jboolean (JNICALL * IsVirtualThread)(JNIEnv *env, jobject obj);', `dnl')
};
struct JNIEnv_ {
...
ifelse(LOOM_SUPPORT, ON, `	jboolean IsVirtualThread(JNIEnv *env, jobject obj) { return functions->IsVirtualThread(this, obj); }', `dnl')
#endif
};
