...
ifdef(LOOM_SUPPORT, [	unsigned int can_support_virtual_threads : 1;], [	unsigned int : 16;])
	unsigned int : 16;
	unsigned int : 16;
	unsigned int : 16;
	unsigned int : 16;
...
ifdef(LOOM_SUPPORT, [	JVMTI_EVENT_VIRTUAL_THREAD_START = 87,], [dnl])
ifdef(LOOM_SUPPORT, [	JVMTI_EVENT_VIRTUAL_THREAD_END = 88,], [dnl])
...
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, [	jvmtiError (JNICALL * AddModuleReads)(jvmtiEnv* env, jobject module, jobject to_module);
	...
	void *reserved117;
ifdef(LOOM_SUPPORT, [	jvmtiError (JNICALL * SuspendAllVirtualThreads)(jvmtiEnv* env, jint except_count, const jthread* except_list);
...
ifdef(LOOM_SUPPORT, [	jvmtiError SuspendAllVirtualThreads (jint except_count, const jthread* except_list) { return functions->SuspendAllVirtualThreads(this, except_count, except_list); }
