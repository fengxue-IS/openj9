...
IDATA VMInitStages(J9JavaVM *vm, IDATA stage, void* reserved) {
	...
	switch(stage) {
		case PORT_LIBRARY_GUARANTEED :
			...
			argIndex = FIND_AND_CONSUME_ARG(EXACT_MATCH, VMOPT_XXNODISCLAIMVIRTUALMEMORY, NULL);
			argIndex2 = FIND_AND_CONSUME_ARG(EXACT_MATCH, VMOPT_XXDISCLAIMVIRTUALMEMORY, NULL);
			{
				IDATA argIndex3;
			...
			argIndex = FIND_AND_CONSUME_ARG(EXACT_MATCH, VMOPT_XXNOTRANSPARENT_HUGEPAGE, NULL);
			argIndex2 = FIND_AND_CONSUME_ARG(EXACT_MATCH, VMOPT_XXTRANSPARENT_HUGEPAGE, NULL);
			{
			...
			argIndex = FIND_AND_CONSUME_ARG(EXACT_MATCH, VMOPT_XXNLSMESSAGES, NULL);
			argIndex2 = FIND_AND_CONSUME_ARG(EXACT_MATCH, VMOPT_XXNONLSMESSAGES, NULL);
			if (argIndex2 > argIndex) {
